...
# Set 2 stages - "staging" and "production"
...
# Copy the vendors folder between releases
set :copy_vendors,          true

# Default value - override in stages/{stage}.rb if needed
set :deploy_via,            :remote_cache

# Common settings, others are in stages/{stage}.rb
...
# Explicitly set composer options
...
# Disable Web before deployment start - this isn't working, it causes some issues with the cache
